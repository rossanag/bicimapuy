...
$repechos.click(function() {     
  ...
  var $curvasNivel = $('input[name="cvNivel"');
  $curvasNivel.click(function() {     
      borrarPath();
      
      if ($curvasNivel.is( ':checked' ))
      {
        
            loadCurvasNivel();
            mapa.addLayer(geoCurvasNivel);
            
      }  
      else
      {
        console.log("no checked curvas nivel");
        mapa.removeLayer(geoCurvasNivel);                
      }
