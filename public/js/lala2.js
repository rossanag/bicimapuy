...
{    
    ...
    function onEachFeature(feature, layer) {    
        ...
        if (feature.geometry.type === "LineString") 
        {
            ...
            if (feature.properties.NIVEL != null)          
            {
                // // Get bounds of polygon
                var bounds = layer.getBounds();
                // Get center of bounds
                ...
                desc = desc + "<br><b>" + feature.properties.NIVEL + "</b>";
    ...
    function resetHighlight(e) {
        ...
        geoCurvasNivel.resetStyle(e.target);
                
    }       

    geoCurvasNivel = L.geoJson(curvasNivel, {
            //Comentado por ahora
               filter: function(feature, layer) {                        
               if (i > cant_max)  
                   return null;
...
{   
    ...
    socket.on('curvasNivel',function (data10) {        
                         
                        curvasNivel = jQuery.parseJSON(data10);
