(function (factory) {
	...
	L.Control.Geocoder = L.Control.extend({
		options: {
			...
			city: '',  // Agregado por mi city y focus		MIO				
		},
		...
		onAdd: function (map) {
			...
			//agregado por mi
			//L.DomEvent.addListener(input, 'focus', this._focus, this);			
			//L.DomEvent.addListener(input, 'blur', this._blur, this);
			// fin evento agregado por mi
		...
		setInputValue: function(nomStringFound)
		{
			this._input.value = nomStringFound;
		},
		...
		_geocode: function(event) {
			...
			this._clearResults();
			// nueva, no iba inputValue MIO
			var inputValue = this._input.value + ' ' + this.options.city;
			this.options.geocoder.geocode(inputValue, this._geocodeResult, this); // Ahora
			//this.options.geocoder.geocode(this._input.value, this._geocodeResult, this); Antes
