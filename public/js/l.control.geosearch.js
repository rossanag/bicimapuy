...
L.Control.GeoSearch = L.Control.extend({
    ...
    _onKeyUp: function (e) {
        ...
        if (e.keyCode === esc) { // escape key detection is unreliable
            ...
            queryString = queryBox.value + ' ' + this.options.city + ' ' + this.options.ctry;   
            //queryBox.value = queryBox.value + ' ' + this.options.city + ' ' + this.options.ctry;
            //this.geosearch(queryBox.value);  // ANTES ERA SOLO ESTA LINEA
            this.geosearch(queryString);
        }
    }
});
